...
conclusions_samplesize_plot <-
  ...
  plot_rain(
    ...
    x_lab = "Direction of the re-analysis conclusion compared to the original effect",
    y_lab = "Sample size"
  )
...
effect_robustness_discipline_plot <-
  plot_rain(data = effect_robustness_discipline_data,
            ...
            x_lab = "Disciplines",
            y_lab = "Effect size estimate range (Cohens'd)",
            trans = "log10",
...
effect_robustness_studytype_plot <- plot_rain(
  ...
  response_var = estimate_range,
  x_lab = "Study type",
  y_lab = "Estimate range in Cohens'd",
  trans = "log10",
  breaks = c(0.01, 0.1, 0.5, 1, 5, 10, 30, 60)
)
