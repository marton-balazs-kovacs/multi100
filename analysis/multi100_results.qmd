...
small_plot_section <-
  ...
  (tolerance_region_expertise_plot |
     tolerance_region_familiarity_plot | tolerance_region_samplesize_plot) +
...
effec_size_corr_plot <- plot_effect_size_correlation(effec_size_corr_plot_data, x_limits = c(0, 5), y_limits = c(-5, 5), annotate_positions = c(4.7, 4))
