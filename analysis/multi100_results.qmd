...
#   dplyr::filter(
#     paper_id %in% c(
#       "Yang_JournMarketRes_2013_G1Lr",
# "PALER_AmPoliSciRev_2013_Pxp7",
# "Ku_JournEnvPsych_2014_YpZZ",
# "Goerg_JournLabEco_2010_WLpV",
# "Einstein_AmJourPoliSci_2017_mxyQ",
# 
# "Cohen_AmEcoRev_2015_2lb5",
# 
# "Behrman_JournPoliEco_2015_G55r",
# 
# "Andreoni_JournPoliEco_2017_La9x"
#     )
#   )
...
ggplot2::ggsave(here::here("figures_barna/demographic_age_plot.jpg"), age_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/demographic_country_plot.jpg"), country_map_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/demographic_experience_years_plot.jpg"), analyst_experience_years_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/demographic_analysis_frequency_plot.jpg"), analysis_frequency_plot, dpi = 300)
...
ggsave(here::here("figures_barna/demographic_expertise_self_rating_plot.jpg"), expertise_self_rating_plot, dpi = 300)
...
ggsave(here::here("figures_barna/demographic_software_plot.jpg"), software_plot, dpi = 300)
...
ggsave(here::here("figures_barna/demographic_total_hours_plot.jpg"), total_hours_plot, dpi = 300)
...
ggsave(here::here("figures_barna/demographic_evaluators_experience_years_plot.jpg"), peer_analyst_experience_years_plot, dpi = 300)
...
ggsave(here::here("figures_barna/demographic_evaluators_analysis_frequency_plot.jpg"), peer_analysis_frequency_plot, dpi = 300)
...
ggsave(here::here("figures_barna/demographic_evaluators_expertise_self_rating_plot.jpg"), peer_expertise_self_rating_plot, dpi = 300)
...
ggsave(here::here("figures_barna/conclusion_main_robustness_plot.jpg"), conclusion_main_robustness_plot, dpi = 300)
...
ggsave(here::here("figures_barna/conclusion_main_plot.jpg"), conclusion_main_plot, width = 9, height = 11.69, dpi = 300)
...
ggsave(here::here("figures_barna/conclusions_discipline_robustness_plot.jpg"), conclusions_discipline_robustness_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/conclusions_discipline_plot.jpg"), conclusions_discipline_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/conclusions_studytype_robustness_plot.jpg"), conclusions_studytype_robustness_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/conclusions_studytype_plot.jpg"), conclusions_studytype_plot, dpi = 300)
...
ggsave(here::here("figures_barna/conclusions_expertise_plot.jpg"), conclusions_expertise_plot, 
       height = 6, width = 8,
       dpi = 300)
...
ggsave(here::here("figures_barna/peer_eval_subset_task1_plot.jpg"), peer_eval_subset_task1_plot, dpi = 300)
...
ggsave(here::here("figures_barna/conclusions_familiarity_plot.jpg"), conclusions_familiarity_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/conclusions_samplesize_plot.jpg"), conclusions_samplesize_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/conclusions_df_plot.jpg"), conclusions_df_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/effect_main_plot.jpg"), plot = effect_main_plot,
       width = 12, height = 13,
       dpi = 300)
...
y_dense <-
  ...
  geom_density(aes(y = ..count.., fill = "Replication"), trim = F, alpha = .5) +
  xlab("") + 
  ylab("") + 
  coord_flip() +
...
x_dense <- 
  ...
  ggplot(aes(x = original_cohens_d)) +
  geom_density(aes(y = ..count.., fill = "Original"), trim = F, alpha = .5) +
  xlab("") + 
  ylab("") +
  scale_fill_manual(values = colors) + 
  theme(
    legend.position = "none",
        plot.margin = unit(c(0, 0, 0, 4), "lines"),
        panel.background = element_blank(),
    panel.grid = element_blank(),
    axis.text = element_blank(),
    axis.ticks = element_blank()
...
scatter <-
  ...
  ggplot(aes(x = original_cohens_d, y = effect_size)) +
    geom_rug(aes(color = "Original"),
           size = 1,
           sides = "b",
           alpha = .6) +
  geom_rug(aes(color = "Replication"),
           size = 1,
           sides = "l",
           alpha = .6) +
  ...
  geom_abline(intercept = 0,
              slope = 1,
              color = "Grey60") +
   geom_smooth(method = "lm", se = FALSE, color = "black", alpha = 0.2) +
  geom_point(
    color = "Grey30",
    shape = 21,
    alpha = .8
  ...
  scale_y_continuous(
    limits = c(-5, 5),
     breaks = c(-4, -3.5, -3, -2.5, -2, -1.5, -1, -0.5, 0, .5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5)
  ) +
  labs(
    x = "Original effect size in Cohen's d",
    y = "Reanalysis effect size in Cohen's d",
    # color = "Type"
  ) +
  theme(
...
row1 <- x_dense | blank_plot
row2 <- scatter | y_dense

# Stack the rows to create the final 2x2 grid
effec_size_corr_plot <- row1 / row2

# Use plot_layout() to specify the relative widths and heights
effec_size_corr_plot <- effec_size_corr_plot + 
  plot_layout(widths = c(4, 1.4), heights = c(1.4, 4))

# effec_size_corr_plot <-
#   gridExtra::grid.arrange(
#     x_dense, blank_plot, scatter, y_dense,
#     ncol = 2, nrow = 2,
#     widths = c(4, 1.4), heights = c(1.4, 4)
#   )

# effec_size_corr_plot <- cowplot::plot_grid(
#   x_dense, blank_plot, scatter, y_dense,
#   ncol = 2, nrow = 2,
#   widths = c(4, 1.4),  # Relative widths
#   heights = c(1.4, 4)  # Relative heights
# )

# SAVE combined plots as PDF
ggplot2::ggsave(here::here("figures_barna/effec_size_corr_plot.jpg"), plot = effec_size_corr_plot,
                width = 13, height = 10,
       dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/effect_region_all_plot.jpg"), effect_region_all_plot, width = 8.27, height = 11.69, dpi = 300)
...
```{r}
thresholds <- seq(0.01, 0.5, by = 0.001)
...
threshold_robustness_plot <-
  ...
  geom_line() +
  scale_x_continuous(breaks = c(0.01, seq(0.05, 0.5, by = 0.05)) * 2, expand = c(0.05, 0)) +
  scale_y_continuous(labels = scales::percent_format(scale = 1), breaks = seq(0, 70, 10)) +
...
ggplot2::ggsave(here::here("figures_barna/threshold_robustness_plot.jpg"), threshold_robustness_plot, height = 4, dpi = 300)
...
threshold_weighted_robustness_plot <-
  ...
  geom_line() +
  scale_x_continuous(breaks = seq(0.05, 0.2, by = 0.05), labels = scales::percent_format(scale = 1), expand = c(0.05, 0)) +
  scale_y_continuous(labels = scales::percent_format(scale = 1), breaks = seq(0, 70, 10)) +
  viridis::scale_fill_viridis(discrete = TRUE) +
  labs(
...
ggplot2::ggsave(here::here("figures_barna/threshold_weighted_robustness_plot.jpg"), threshold_weighted_robustness_plot, height = 4, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/effect_region_discipline_plot.jpg"), effect_region_discipline_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/effect_robustness_discipline_plot.jpg"), effect_robustness_discipline_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/effect_region_studytype_plot.jpg"), effect_region_studytype_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/effect_robustness_studytype_plot.jpg"), effect_robustness_studytype_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/effect_region_expertise_plot.jpg"), effect_region_expertise_plot, dpi = 300,
                # width = 8, height = 6
                )
...
ggplot2::ggsave(here::here("figures_barna/effect_region_familiarity_plot.jpg"), effect_region_familiarity_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/effect_region_samplesize_plot.jpg"), samplesize_region_plot, dpi = 300)
...
ggplot2::ggsave(here::here("figures_barna/effect_region_df_plot.jpg"), df_region_plot, dpi = 300)
...
ggsave("figures/inferential_panel.png", inferential_panel, width = 22, height = 14, dpi = 300)
...
ggsave("figures/estimate_panel.png", estimate_panel, width = 30, height = 14, dpi = 300)
```
