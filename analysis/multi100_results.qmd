...
```{r data processing for df_region_plot, include=FALSE}
df_region_data <-
  processed |>
  dplyr::select(
    paper_id,
...
```{r generating conclusion_main_robustness_plot, include=FALSE}
...
```{r generating conclusions_df_plot, include=FALSE}
