...
peer_eval <- 
  peer_eval %>% 
  # TODO: change it to concrete id, is this correct?
...
According to the decision of the expert panel `r nrow(peer_eval_change)` decisions made by the peer evaluators were modified.
