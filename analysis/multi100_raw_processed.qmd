...
Remove case where evaluator is also co-analyst (!SN. 462: WJVLO_Pastötter_Cognition_2013_EQxa_WJVLO). We decided to treat this responses as non-valid response and do not include it in the summary statistics for the peer evaluation in the results section of the paper.
