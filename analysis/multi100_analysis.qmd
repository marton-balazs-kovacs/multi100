...
conclusion_main_plot <-
  plot_conclusion(conclusions_main_data, Paper_ID) +
  theme(
...
conclusions_discipline_data <- 
  ...
  calculate_conclusion(., Paper_Discipline)

conclusions_discipline_plot <- plot_conclusion(conclusions_discipline_data, Paper_Discipline) + theme(legend.text = element_text(size = 6))
