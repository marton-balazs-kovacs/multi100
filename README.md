...
- `multi100_analysis.qmd` file contains the code for the figure creation
  and the analysis.
...
`multi100_analysis.Rmd` file. Note that the figures will not look
exactly the same as in the final paper due to post-hoc editing.
