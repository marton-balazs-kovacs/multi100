...
-   `multi100_analysis.Rmd` file contains the code for the figure
...
- Operating System Tested On:
  - __Primary OS:__ Windows 11 64bit, Linux Mint 20.3 64bit
  - __R Version:__ 4.3.0, 4.4.2
  - __Package Versions:__ As specified in `renv.lock`.

### 2. Required Hardware For Smooth Operation

  - __Standard Hardware:__ The analysis can be run on standard desktop or
    laptop computers with at least:
  - __RAM:__ Minimum 4GB
  - __Processor:__ modern multi-core CPU 
  - __Non-Standard Hardware:__ None required.
...
This command will:
  ...
  - Install the exact versions of all packages listed
in `renv.lock`.
...
This command will generate the main manuscript and save each figure separately. Generating the main manuscript takes about 7 minutes on an average computer.